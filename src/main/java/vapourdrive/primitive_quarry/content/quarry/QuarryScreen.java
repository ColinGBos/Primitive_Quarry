...
public class QuarryScreen extends AbstractBaseMachineScreen<QuarryMenu> {
    protected final QuarryMenu machineContainer;
    protected int imgHeight = 209;

    public QuarryScreen(QuarryMenu container, Inventory inv, Component name) {
