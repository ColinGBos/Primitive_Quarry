...
public class Registration {
    ...
    public static final RegistryObject<Item> PRIMITIVE_QUARRY_ITEM = ITEMS.register("primitive_quarry", () -> new QuarryItem(PRIMITIVE_QUARRY_BLOCK.get(), new Item.Properties().tab(ModSetup.VAPOUR_GROUP)));
